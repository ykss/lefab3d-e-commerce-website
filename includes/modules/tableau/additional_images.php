...
//  End Image Handler changes 2 of 2
    ...
    if (file_exists($products_image_large)) {
        $large_image = $products_image_large;
    } else {
        $large_image = $base_image;
    }
    
    $script_link = '<a href="'. $large_image . '">' . zen_image($base_image, $products_name, SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>';
