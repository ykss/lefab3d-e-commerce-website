...
//  $showFixedQuantityAmount = $products[$i]['quantity'] . zen_draw_hidden_field('cart_quantity[]', 1);
  ...
  $buttonUpdate = ((SHOW_SHOPPING_CART_UPDATE == 1 or SHOW_SHOPPING_CART_UPDATE == 3) ? '<a href="#" onclick="$(this).closest(\'form\').submit(); return false;" class="update-btn">Update</a>' : '') . zen_draw_hidden_field('products_id[]', $products[$i]['id']);
