...
define('NAVBAR_TITLE_2', 'Communications');

define('HEADING_TITLE', 'Communications');

define('MY_NEWSLETTERS_TITLE', 'Newsletter Subscriptions');
define('MY_EMAIL_PREFERENCES_TITLE', 'E-mail Preferences');
define('MY_NEWSLETTERS_OPTION_1', 'Subscribe me to the ' . STORE_NAME . ' Newsletter');
define('MY_NEWSLETTERS_OPTION_2', 'Do not subscribe me to the ' . STORE_NAME . ' Newsletter');
