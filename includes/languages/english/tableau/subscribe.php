...
define('TEXT_INFORMATION_CONFIRM', '
  <p>Before you begin receiving your subscription to our newsletter, you must reply to our subscribe-confirm request sent to your email<strong>%s</strong>.</p>
  
  <p>Please check your e-mail inbox. When you receive the confirmation request, just click on the confirmation link enclosed in the email. If you have troubles signing up, please send a message to <a href="mailto:' . STORE_OWNER_EMAIL_ADDRESS . '">'. STORE_OWNER_EMAIL_ADDRESS .'</a>.</p>
  ');
...
define('TEXT_NEWSONLY_SUBSCRIPTIONS_DISABLED', "Subscriptions disabled.");
