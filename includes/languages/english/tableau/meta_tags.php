...
// page title
define('TITLE', 'Tableau');

// Site Tagline
define('SITE_TAGLINE', 'Responsive Zen Cart Template');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'zen cart, responsive, template, theme, numinix, tableau, mobile, tablet');
