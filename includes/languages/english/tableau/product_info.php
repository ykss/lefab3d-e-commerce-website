...
// reviews
define('TITLE_REVIEWS', 'Reviews');
define('TEXT_READ_REVIEWS', 'Read Reviews');
define('TEXT_WRITE_REVIEWS', 'Write a Review');
define('TEXT_OVERALL_RATINGS', 'Overall Rating');
define('TEXT_BE_THE_FIRST', 'Be the first to write a review.');

// price
define('TEXT_PRICE', 'Price:');

// tabs/accordion
define('TEXT_TAB_ACCORDION_DESCRIPTION', 'Product Description');
define('TEXT_TAB_ACCORDION_SPECIFICATIONS', 'Specifications');
define('TEXT_TAB_ACCORDION_FEATURES', 'Features');
...
define('TEXT_XSELL_PRODUCTS', 'Recommended Product');
