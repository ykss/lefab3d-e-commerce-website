...
// footer text in includes/footer.php
  ...
  define('FOOTER_TITLE_SHOP', 'Shop');
  define('FOOTER_ITEM_ALL_CATEGORIES', 'All Categories');
  define('FOOTER_TITLE_CUSTOMER_SERVICE', 'Customer Services');
  define('FOOTER_ITEM_MY_ACCOUNT', 'My Account');
  define('FOOTER_ITEM_CONTACT_US', 'Contact Us');
  define('FOOTER_ITEM_DISCOUT_COUPON', 'Discount Coupons');
  define('FOOTER_ITEM_GET_CERTIFICATE', 'Get Certificate FAQ');
  define('FOOTER_ITEM_POLICY_PRIVACY', 'Policies &amp; Privacy');
  define('FOOTER_ITEM_SHIPPING_RETURNS', 'Shipping &amp; Returns');
  define('FOOTER_ITEM_PRIVACY_POLICY', 'Privacy Policy');
  define('FOOTER_ITEM_CONDITIONS_USE', 'Conditions of Use');
  define('FOOTER_ITEM_WARRANTY', 'Warranty');

  define('FOOTER_TITLE_NEWSLETTER', 'Newsletter');
  define('FOOTER_ITEM_NEWSLETTER_SUBSCRIBE', 'Subscribe');
  define('FOOTER_ITEM_NEWSLETTER_UNSUBSCRIBE', 'Newsletter Unsubscribe');

  define('FOOTER_DESINGED_BY', 'Web Design by <a href="https://www.numinix.com/" target="_blank">Numinix</a>');
...
// javascript messages
  ...
  define('CATEGORY_PERSONAL', 'Billing Address');
  ...
  define('ENTRY_FIRST_NAME_ERROR', 'Your First Name must be a minimum of ' . ENTRY_FIRST_NAME_MIN_LENGTH . ' characters.');
  define('ENTRY_FIRST_NAME_TEXT', '*');
  define('ENTRY_LAST_NAME', 'Last Name:');
  define('ENTRY_LAST_NAME_ERROR', 'Your Last Name must be a minimum of ' . ENTRY_LAST_NAME_MIN_LENGTH . ' characters.');
  ...
  define('ENTRY_EMAIL_ADDRESS_ERROR', 'Your email address must be at least ' . ENTRY_EMAIL_ADDRESS_MIN_LENGTH . ' characters.');
  define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', 'Invalid email address. Please try again.');
  ...
  define('ENTRY_STREET_ADDRESS_ERROR', 'Your Street Address must be a minimum of ' . ENTRY_STREET_ADDRESS_MIN_LENGTH . ' characters.');
  define('ENTRY_STREET_ADDRESS_TEXT', '*');
  define('ENTRY_SUBURB', 'Address Line 2:');
  define('ENTRY_SUBURB_ERROR', '');
  define('ENTRY_SUBURB_TEXT', '');
  define('ENTRY_POST_CODE', 'Zip / Postal Code:');
  define('ENTRY_POST_CODE_ERROR', 'Your Zip / Postal Code must be a minimum of ' . ENTRY_POSTCODE_MIN_LENGTH . ' characters.');
  define('ENTRY_POST_CODE_TEXT', '*');
  define('ENTRY_CITY', 'City:');
  define('ENTRY_CUSTOMERS_REFERRAL', 'Referral Code:');

  define('ENTRY_CITY_ERROR', 'Your City must be a minimum of ' . ENTRY_CITY_MIN_LENGTH . ' characters.');
  ...
  define('ENTRY_TELEPHONE_NUMBER_ERROR', 'Your Telephone Number must be a minimum of ' . ENTRY_TELEPHONE_MIN_LENGTH . ' characters.');
  ...
  define('ENTRY_PASSWORD_ERROR', 'Your Password must be a minimum of ' . ENTRY_PASSWORD_MIN_LENGTH . ' characters.');
  ...
  define('PREVNEXT_BUTTON_PREV', '<span class="prev-button">&#xe008;</span>');
  define('PREVNEXT_BUTTON_NEXT', '<span class="next-button">&#xe00b;</span>');
  ...
  define('TEXT_BY', '<span>By:</span> ');
  define('TEXT_BY_2', 'By:');

  define('TEXT_REVIEW_BY', '<span>By:</span> %s');
...
// create account - login shared
  ...
  define('ENTRY_EMAIL_PREFERENCE','Communication Preferences');
