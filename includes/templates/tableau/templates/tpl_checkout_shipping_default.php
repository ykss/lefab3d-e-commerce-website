 ...
 */
?>
<div class="centerColumn checkout_pages" id="checkoutShipping">
...
<div class="col-left col-first">
    ...
    <div id="checkoutShipto" class="box">
    ...
    <p class="shipping-message"><?php echo TEXT_CHOOSE_SHIPPING_DESTINATION; ?></p>
</div>
...
<div class="col-right">
    ...
    <p id="checkoutShippingContentChoose" class="important"><?php echo TEXT_NO_SHIPPING_AVAILABLE; ?></p>
    <?php
      }
    ?>
    ...
    <div class="container-button">
        ...
        <div class="back"><?php echo '<strong>' . TITLE_CONTINUE_CHECKOUT_PROCEDURE . '</strong><br />' . TEXT_CONTINUE_CHECKOUT_PROCEDURE; ?></div>
    </div>
</div>
</form>
</div>