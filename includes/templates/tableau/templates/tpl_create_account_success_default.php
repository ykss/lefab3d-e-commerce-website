...
<h1 id="createAcctSuccessHeading"><?php echo HEADING_TITLE; ?></h1>
	...
	<div class="content"><?php echo TEXT_ACCOUNT_CREATED; ?></div>
	...
	<div class="buttonRow"><?php echo '<a href="' . $origin_href . '">' . zen_image_button(BUTTON_IMAGE_CONTINUE, BUTTON_CONTINUE_ALT) . '</a>'; ?></div>
</div>
