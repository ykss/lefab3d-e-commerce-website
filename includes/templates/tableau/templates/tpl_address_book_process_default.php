...
<h1 id="addressBookProcessDefaultHeading"><?php echo $breadcrumb->last();  ?></h1>
...
<div id="account-content" class="delete-address">
	...
	<div class="account-info-wrapper delete-container">
		...
		<address class=""><?php echo zen_address_label($_SESSION['customer_id'], $_GET['delete'], true, ' ', '<br />'); ?></address>
...
<h1 id="addressBookProcessDefaultHeading" class="back"><?php if (isset($_GET['edit'])) { echo HEADING_TITLE_MODIFY_ENTRY; } elseif (isset($_GET['delete'])) { echo HEADING_TITLE_DELETE_ENTRY; } else { echo HEADING_TITLE_ADD_ENTRY; } ?></h1>
...
?>
<div class="buttonRow"><?php echo zen_draw_hidden_field('action', 'update') . zen_draw_hidden_field('edit', $_GET['edit']) . zen_image_submit(BUTTON_IMAGE_UPDATE, BUTTON_UPDATE_ALT); ?></div>
...
?>
<div class="buttonRow"><?php echo zen_draw_hidden_field('action', 'process') . zen_image_submit(BUTTON_IMAGE_SUBMIT, BUTTON_SUBMIT_ALT); ?></div>
