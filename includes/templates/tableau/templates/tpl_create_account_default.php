...
<h1 id="createAcctDefaultHeading" class="back"><?php echo HEADING_TITLE; ?></h1>

<div class="alert forward required-information"><?php echo FORM_REQUIRED_INFORMATION; ?></div>
