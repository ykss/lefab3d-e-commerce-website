 ...
 */
  ...
  if (strtolower(IMAGE_USE_CSS_BUTTONS) == 'yes') {
    ...
    $content .= zen_draw_input_field('keyword', '', 'size="6" maxlength="30" style="width: 100px" value="' . HEADER_SEARCH_DEFAULT_TEXT . '" onfocus="if (this.value == \'' . HEADER_SEARCH_DEFAULT_TEXT . '\') this.value = \'\';" onblur="if (this.value == \'\') this.value = \'' . HEADER_SEARCH_DEFAULT_TEXT . '\';"') . '<button type="submit" value="' . HEADER_SEARCH_BUTTON . '">' . HEADER_SEARCH_BUTTON . '</button>';
  }
  $content .= "</form>";
?>